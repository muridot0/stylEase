export const data = [
  {
    "title": "Node Drawer",
    "content": "Expand the drawer to view all available nodes and find out how to use them!",
    "src": "/node-drawer-light.jpeg",
    "darkSrc": "/node-drawer-dark.jpeg",
    "icon": "i-iconoir-drawer"
  },
  {
    "title": "Preview Image",
