...
importScripts('https://cdn.jsdelivr.net/npm/@magenta/image@^0.2.1')
...
class ArbitraryStyleTransferNetwork {
  ...
  async initialize() {
    ...
    this.transferModel = await tf.loadGraphModel('https://kaggle.com/models/google/arbitrary-image-stylization-v1/frameworks/TensorFlow1/variations/256/versions/1', {fromTFHub: true})
...
self.onmessage = async function (event) {
  ...
  const res = await model.stylize(scaledContentImageData, scaledStyleImageData)
    console.log(res)
      // .then((imageData) => {
      //   console.log('i got here')
      //   return postMessage(imageData)
      // })
  }
